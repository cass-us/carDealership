  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-gray-400 font-small text-sm">We are committed to providing the best services.</p>
      </div>
    </div>
  );
};
